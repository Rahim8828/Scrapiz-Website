...
const Bandra = () => {
  ...
  const schema = {
    ...
    "name": "Scrapiz Bandra - Scrap Buyers & Scrap Dealers in Mumbai",
    ...
    "image": "https://www.scrapiz.in/Scrapiz-Bandra.jpeg",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "R15, Service Road Y Colony, Bandra East",
      "addressLocality": "Mumbai",
      "addressRegion": "Maharashtra",
      "postalCode": "400051",
    },
    "telephone": "+918828795435",
    "url": "https://www.scrapiz.in/bandra",
    "mainEntity": {
        "@type": "FAQPage",
  ...
  return (
    <>
      <Helmet>
        <title>Scrapiz Bandra - Scrap Buying and Recycling Services</title>
        <meta name="description" content="Sell your scrap in Bandra with Scrapiz – reliable scrap buyers in Mumbai. We provide free pickup, digital weighing, and eco-friendly recycling" />
        <meta name="keywords" content="scrap dealer near me, scrap buyer, Bandra, Mumbai, scrap recycling, best scrap rates, free pickup, Online kabadiwala, scrap dealer near me, scrap dealer in bandra" />
        <link rel="canonical" href="https://www.scrapiz.in/bandra" />
      ...
      <div className="bg-white text-gray-800">
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              Looking to sell scrap in Bandra? Scrapiz makes it easy with doorstep pickup, instant payment, and best scrap rates. Whether you’re in Bandra West or Bandra East, our team reaches you the same day.
            </motion.p>
            <div className="mt-8 flex justify-center gap-4">
              <motion.a
                href="tel:+918828795435"
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
                <p className="text-lg text-gray-800 text-left leading-relaxed">
                    Scrapiz is the most trusted <strong>scrap dealer in Bandra</strong>, offering free doorstep scrap pickup, instant payment, and the best scrap rates. We proudly serve both <strong>Bandra East</strong> and <strong>Bandra West</strong>, covering areas like Pali Hill, Carter Road, and Bandstand.
                    <br/><br/>
                    Whether you want to <strong>sell scrap in Bandra</strong> from your home, office, or shop, our team makes the process fast and hassle-free. From iron, steel, aluminum, and copper to plastic, paper, e-waste, and old furniture, we buy all types of scrap at the highest prices.
                </p>
            </motion.div>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  Get the highest market rates for all types of scrap materials
                  in Bandra
                </p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  Doorstep collection service for bulk scrap materials across
                  Bandra
                </p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  Authorized scrap dealer with proper licensing and eco-friendly
                  recycling
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="space-y-6 mb-8">
                  <div className="flex items-start">
                    <MapPin className="w-8 h-9 text-green-500 mt-1 mr-4" />
                    <div>
                      <h3 className="font-bold">Our Address</h3>
                      <p>
                        R15, Service Road Y Colony, Bandra East, Mumbai,
                        Maharashtra 400051
                      </p>
                    </div>
                  </div>
