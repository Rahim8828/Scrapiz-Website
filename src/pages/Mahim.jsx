...
const Mahim = () => {
  ...
  const schema = {
    ...
    "name": "Scrapiz Mahim - Scrap Buyers & Scrap Dealers in Mumbai",
    ...
    "image": "https://www.scrapiz.in/Mahim-West.jpeg",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "Shop No 1, Mustafa Building, Old Cadel Rd, Kapad Bazar, Mahim West, Mahim",
      "addressLocality": "Mumbai",
      "addressRegion": "Maharashtra",
      "postalCode": "400016"
    },
    "telephone": "+919920389656",
    "url": "https://www.scrapiz.in/mahim",
    "mainEntity": {
        "@type": "FAQPage",
  ...
  return (
    <>
      <Helmet>
        <title>Scrapiz Mahim - Scrap Buying and Recycling Services</title>
        <meta name="description" content="Sell your scrap in Mahim with Scrapiz – reliable scrap buyers in Mumbai. We provide free pickup, digital weighing, and eco-friendly recycling" />
        <meta name="keywords" content="scrap buyer, Mahim, Mumbai, scrap recycling, best scrap rates, free pickup, Online kabadiwala, scrap dealer near me, scrap dealer in mahim" />
        <link rel="canonical" href="https://www.scrapiz.in/mahim" />
      ...
      <div className="bg-white text-gray-800">
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              Looking to sell scrap in Mahim? Scrapiz makes it easy with doorstep pickup, instant payment, and best scrap rates. Whether you’re in Mahim West or Mahim East, our team reaches you the same day.
            </motion.p>
            <div className="mt-8 flex justify-center gap-4">
              <motion.a
                href="tel:+919920389656"
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-bold mb-12">Why Choose Scrapiz Mahim?</h2>
            <motion.div
            ...
            >
                <p className="text-lg text-gray-800 text-left leading-relaxed">
                    Scrapiz is the most trusted <strong>scrap dealer in Mahim</strong>, offering free doorstep scrap pickup, instant payment, and the best scrap rates. We proudly serve <strong>Mahim</strong>, covering areas like Mahim Bay, Shivaji Park, and Hindu Colony.
                    <br/><br/>
                    Whether you want to <strong>sell scrap in Mahim</strong> from your home, office, or shop, our team makes the process fast and hassle-free. From iron, steel, aluminum, and copper to plastic, paper, e-waste, and old furniture, we buy all types of scrap at the highest prices.
                </p>
            </motion.div>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">Get the highest market rates for all types of scrap materials in Mahim</p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-md">
                <Truck className="w-12 h-12 text-blue-500 mx-auto mb-4" />
                <h3 className="text-2xl font-bold mb-2">Free Pickup Service</h3>
                <p className="text-gray-600">Doorstep collection service for bulk scrap materials across Mahim</p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-md">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                <div className="rounded-xl flex items-center justify-center mb-8 overflow-hidden">
                    <img src="/Mahim-West.jpeg" alt="Scrapiz Mahim Shop" className="w-full h-auto rounded-lg" />
                </div>
              ...
              <div>
                ...
                <div className="space-y-6 mb-8">
                    <div className="flex items-start">
                        ...
                        <p>Shop No 1, Mustafa Building, Old Cadel Rd, Kapad Bazar, Mahim West, Mahim, Mumbai, Maharashtra 400016</p>
                        </div>
                    </div>
                  ...
                  >
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3771.823939158654!2d72.84156431489993!3d19.02741548711588!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7ce87393430c3%3A0x88df6933589a16b!2sScrapiz%20-%20Scrap%20Dealer%20in%20Mahim!5e0!3m2!1sen!2sin!4v1676903212894!5m2!1sen!2sin"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen=""
                      ...
                      title="Google Map of Scrapiz Location in Mahim"
                    ></iframe>
                  </motion.div>
                </div>
              </div>
