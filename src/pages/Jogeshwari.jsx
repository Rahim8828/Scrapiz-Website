...
const Jogeshwari = () => {
  ...
  const schema = {
    ...
    "name": "Scrapiz Jogeshwari - Scrap Buyers & Scrap Dealers in Mumbai",
    ...
    "image": "https://www.scrapiz.in/Scrapiz-Jogeshwari.jpeg",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "Shop No 08, A K Compound, Behram Baug Rd, near Tech Web Center, Anand Nagar, Jogeshwari West",
      "addressLocality": "Mumbai",
      "addressRegion": "Maharashtra",
      "postalCode": "400102"
    },
    "telephone": "+917607803670",
    "url": "https://www.scrapiz.in/jogeshwari",
    "mainEntity": {
      "@type": "FAQPage",
  ...
  return (
    <>
      <Helmet>
        <title>Scrapiz Jogeshwari - Scrap Buying and Recycling Services</title>
        <meta name="description" content="Sell your scrap in Jogeshwari with Scrapiz – reliable scrap buyers in Mumbai. We provide free pickup, digital weighing, and eco-friendly recycling" />
        <meta name="keywords" content="scrap buyer, Jogeshwari, Mumbai, scrap recycling, best scrap rates, free pickup, Online kabadiwala, scrap dealer near me, scrap dealer in jogeshwari" />
        <link rel="canonical" href="https://www.scrapiz.in/jogeshwari" />
      ...
      <div className="bg-white text-gray-800">
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
             Looking to sell scrap in Jogeshwari? Scrapiz makes it easy with doorstep pickup, instant payment, and best scrap rates.Whether you’re in Jogeshwari West or Jogeshwari East. our team reaches you the same day.
            </motion.p>
            <div className="mt-8 flex justify-center gap-4">
              <motion.a
                href="tel:+917607803670"
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-bold mb-12">Why Choose Scrapiz Jogeshwari?</h2>
            <motion.div
            ...
            >
                <p className="text-lg text-gray-800 text-left leading-relaxed">
                    Scrapiz is the most trusted <strong>scrap dealer in Jogeshwari</strong>, offering free doorstep scrap pickup, instant payment, and the best scrap rates. We proudly serve both <strong>Jogeshwari East</strong> and <strong>Jogeshwari West</strong>, covering areas like RM Road, Gulshan Nagar, Anand Nagar, and Badi Masjid.
                    <br/><br/>
                    Whether you want to <strong>sell scrap in Jogeshwari</strong> from your home, office, or shop, our team makes the process fast and hassle-free. From iron, steel, aluminum, and copper to plastic, paper, e-waste, and old furniture, we buy all types of scrap at the highest prices.
                </p>
            </motion.div>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">Get the highest market rates for all types of scrap materials in Jogeshwari</p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-md">
                <Truck className="w-12 h-12 text-green-500 mx-auto mb-4" />
                <h3 className="text-2xl font-bold mb-2">Free Pickup Service</h3>
                <p className="text-gray-600">Doorstep collection service for bulk scrap materials across Jogeshwari</p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-md">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                <div className="rounded-xl flex items-center justify-center mb-8 overflow-hidden">
                    <img src="/Scrapiz-Jogeshwari.jpeg" alt="Scrapiz Jogeshwari" className="w-full h-auto rounded-lg" />
                </div>
              ...
              <div>
                ...
                <div className="space-y-6 mb-8">
                    <div className="flex items-start">
                        ...
                        <p>Shop No 08, A K Compound, Behram Baug Rd, near Tech Web Center, Anand Nagar, Jogeshwari West, Mumbai, Maharashtra 400102</p>
                        </div>
                    </div>
                  ...
                  <h2 className="text-4xl font-bold text-start text-gray-800 my-8">
                    Find Us On Map
                  </h2>
                  <motion.div
                  ...
                  >
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14487.416669682882!2d72.81720808715819!3d19.14779949999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b76fbfb1cb87%3A0xa21b6aa43e2b02af!2sScrapiz!5e1!3m2!1sen!2sin!4v1757269451930!5m2!1sen!2sin"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen=""
