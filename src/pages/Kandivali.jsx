...
const Kandivali = () => {
  ...
  const schema = {
    ...
    "name": "Scrapiz Kandivali - Scrap Buyers & Scrap Dealers in Mumbai",
    ...
    "image": "https://www.scrapiz.in/Scrapiz-Kandivali.jpeg",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "Shop No 11, Durga Seva Samiti, behind Krishna Hotel, Kandivali, Bhut Nagar, Kandivali West",
      "addressLocality": "Mumbai",
      "addressRegion": "Maharashtra",
      "postalCode": "400067"
    },
    "telephone": "+918828700630",
    "url": "https://www.scrapiz.in/kandivali",
    "mainEntity": {
      "@type": "FAQPage",
  ...
  return (
    <>
      <Helmet>
        <title>Scrapiz Kandivali - Scrap Buying and Recycling Services</title>
        <meta name="description" content="Sell your scrap in Kandivali with Scrapiz – reliable scrap buyers in Mumbai. We provide free pickup, digital weighing, and eco-friendly recycling" />
        <meta name="keywords" content="scrap buyer, Kandivali, Mumbai, scrap recycling, best scrap rates, free pickup, Online kabadiwala, scrap dealer near me, scrap dealer in kandivali" />
        <link rel="canonical" href="https://www.scrapiz.in/kandivali" />
      ...
      <div className="bg-white text-gray-800">
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              Looking to sell scrap in Kandivali? Scrapiz makes it easy with doorstep pickup, instant payment, and best scrap rates.Whether you’re in Kandivali. our team reaches you the same day.
            </motion.p>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-bold mb-12">Why Choose Scrapiz Kandivali?</h2>
            <motion.div
            ...
            >
                <p className="text-lg text-gray-800 text-left leading-relaxed">
                    Scrapiz is the most trusted <strong>scrap dealer in Kandivali</strong>, offering free doorstep scrap pickup, instant payment, and the best scrap rates. We proudly serve <strong>Kandivali</strong>.
                    <br/><br/>
                    Whether you want to <strong>sell scrap in Kandivali</strong> from your home, office, or shop, our team makes the process fast and hassle-free. From iron, steel, aluminum, and copper to plastic, paper, e-waste, and old furniture, we buy all types of scrap at the highest prices.
                </p>
            </motion.div>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">Get the highest market rates for all types of scrap materials in Kandivali</p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-md">
                <Truck className="w-12 h-12 text-blue-500 mx-auto mb-4" />
                <h3 className="text-2xl font-bold mb-2">Free Pickup Service</h3>
                <p className="text-gray-600">Doorstep collection service for bulk scrap materials across Kandivali</p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-md">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                <div className="rounded-xl flex items-center justify-center mb-8 overflow-hidden">
                    <img src="/Scrapiz-Kandivali.jpeg" alt="Scrapiz Kandivali Shop" className="w-full h-auto rounded-lg" />
                </div>
              ...
              <div>
                ...
                <div className="space-y-6 mb-8">
                    <div className="flex items-start">
                        ...
                        <p>Shop No 11, Durga Seva Samiti, behind Krishna Hotel, Kandivali, Bhut Nagar, Kandivali West, Mumbai, Maharashtra 400067</p>
                        </div>
                    </div>
                  ...
                  >
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d40960.504554249266!2d72.80468673779062!3d19.21252062847649!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b7b863069eed%3A0x561c3b72781efc45!2sScrapiz!5e1!3m2!1sen!2sin!4v1757270630424!5m2!1sen!2sin"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen=""
