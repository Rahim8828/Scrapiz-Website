...
const ScrapDealerinVidyavihar = ({ openModal }) => {
  const locationData = {
    name: 'Vidyavihar',
    title: 'Scrap Buyer in Vidyavihar – Free Pickup & Best Price',
    description: 'Sell scrap in Vidyavihar with Scrapiz. Free doorstep pickup, instant cash, best scrap rates. We buy metal, e-waste, AC, copper, furniture & more. Call now!',
    phone: '8828700630',
    ...
    areas: [
      'Vidyavihar Station', 'Vidyavihar East', 'Vidyavihar West', 'Kannamwar Nagar', 'Amar Mahal', 'Vikhroli Link Road', 'Ghatkopar Link Road', 'Sonapur', 'Tilak Nagar', 'VN Purav Marg', 'Rajawadi', 'Kannamwar Nagar 1', 'Kannamwar Nagar 2', 'Tagore Nagar', 'Deonar'
    ],
    landmarks: [
      'Vidyavihar Railway Station', 'Kannamwar Nagar', 'Amar Mahal Junction', 'Sonapur Market', 'Tagore Nagar', 'Vikhroli Link Road', 'Tilak Nagar', 'VN Purav Marg'
    ],
    scrapTypes: [
  ...
  const features = [
    {
      ...
      description: 'Get the highest market rates for all types of scrap materials in Vidyavihar.',
  ...
  const testimonials = [
    {
      name: 'Rajesh Sharma',
      area: 'Kannamwar Nagar',
      rating: 5,
      text: 'Best scrap dealer in Vidyavihar! Got excellent rates for my old AC and fridge. Team was very professional.'
    },
    {
      name: 'Anjali Gupta',
      area: 'Amar Mahal',
  ...
  const faqs = [
    {
      question: 'Do you offer free scrap pickup in Vidyavihar?',
      answer: 'Yes, Scrapiz provides 100% free doorstep pickup service anywhere in Vidyavihar. We don\'t have a strict minimum quantity. However, for very small amounts, a nominal convenience fee of ₹60 might apply. For most household scrap accumulations (20-30 kg), the pickup is completely free. No hidden charges!'
    },
    {
      question: 'How fast can your team reach for scrap pickup?',
      answer: 'Our team usually reaches within 30-45 minutes in Vidyavihar area, depending on traffic conditions. We offer same-day pickup service for urgent requirements.'
    },
    {
      question: 'What types of scrap do you buy in Vidyavihar?',
    ...
    },
    {
      ...
      answer: 'Yes, we specialize in bulk scrap pickup for residential societies, commercial buildings, offices, shops, studios, and restaurants in Vidyavihar. We handle large quantities efficiently.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes, we buy all types of old and non-working AC units, refrigerators, washing machines, microwaves, and other home appliances at the best rates in Vidyavihar.'
    },
    {
  ...
  const schemaMarkup = {
    ...
    "@type": "LocalBusiness",
    "name": "Scrapiz - Scrap Dealer in Vidyavihar",
    ...
    "url": "https://www.scrapiz.in/scrap-dealer-in-vidyavihar",
    "areaServed": "Vidyavihar, Mumbai",
    "priceRange": "₹₹",
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.scrapiz.in/scrap-dealer-in-vidyavihar" />
      ...
      <section className="relative bg-gradient-to-br from-green-50 via-green-100 to-emerald-50 pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-green-700 font-semibold">Serving Vidyavihar & Nearby Areas</span>
          </div>
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-700 mb-6 sm:mb-8 max-w-3xl leading-relaxed">
            Looking to <strong>sell scrap in Vidyavihar</strong>? Scrapiz offers <strong>free doorstep pickup</strong>, 
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 mb-8">
            ...
            {openModal && (
              <button
                onClick={() => openModal('Scrap Pickup - Vidyavihar')}
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                Professional Scrap Collection Services in Vidyavihar
              </h2>
              <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
                <p>
                  <strong>Scrapiz</strong> is the most trusted and reliable <strong>scrap dealer in Vidyavihar</strong>, 
              ...
              <div className="mt-8 p-6 bg-white rounded-xl shadow-md border-l-4 border-green-600">
                ...
                <p className="text-gray-700">
                  We offer the highest scrap rates in Vidyavihar based on current market prices. 
            ...
            <div className="space-y-6">
              <div className="bg-white p-5 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl shadow-lg">
                ...
                <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">Complete scrap pickup coverage across Vidyavihar:</p>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Trusted by 500+ customers in Vidyavihar
            </p>
          </div>
...
export default ScrapDealerinVidyavihar;
